...
public class DreamGeek {
    ...
    //EDIT 11: these can no longer be final, as they may not be initialised
    private int minAge;
    private int maxAge;
     ...
     * @param starSign an enum representing the geek's star sign
     */
    //EDIT 11: a new constructor to create the 'dream' representation of real geeks without age range
