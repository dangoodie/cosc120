...
public class StudyBuddy extends DreamGeek{
    //EDIT 8 and 10: these can no longer be final, as they may not be initialised
     ...
     *
     */
    //EDIT 10: create a constructor for objects created to represent real geeks - no age range
    public StudyBuddy(Gender gender, StarSign starSign, String institution, String course, String subjectArea){//}, String subjectArea) {
     ...
     * @param institution      a String representing where the geek is studying, e.g. University of New England
     */
    //EDIT 8: create a constructor for objects create when the user selects institution/course
     ...
     * @param subjectArea      a String representing the general discipline the geek is studying, e.g. IT
     */
    //EDIT 8: create a constructor for objects create when the user selects subject area
    public StudyBuddy(int minAge, int maxAge, Gender gender, StarSign starSign, String subjectArea){//String institution, String course) {
        super(minAge, maxAge, gender, starSign);
        //this.institution=institution;
        //this.course=course;
        this.subjectArea=subjectArea;
