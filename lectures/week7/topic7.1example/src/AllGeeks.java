...
public class AllGeeks {
     ...
     */
    public List<Geek> findDreamGeek(DreamGeek dreamGeek,String username){//EDIT 14: }, TypeOfDreamGeek type){
        ...
        for(Geek g: geeks){
            ...
            //EDIT 14: if(type.equals(TypeOfDreamGeek.FRIEND) && (genericFeatures instanceof MoreThanAFriend)) continue;
