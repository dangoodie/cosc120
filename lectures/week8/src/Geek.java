...
public class Geek {
    ...
    public String getGeekDescription(Set<Criteria> criteriaToDisplay){ //EDIT 32: add parameter
        return this.getName()+" is "+this.getAge()+" years old. "+this.genericFeatures.getDescription(criteriaToDisplay)+
