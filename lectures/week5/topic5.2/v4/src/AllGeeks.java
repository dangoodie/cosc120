...
public class AllGeeks {
    ...
    public List<Geek> findDreamGeek(DreamGeek dreamGeek,String username){
        ...
        for(Geek g: geeks){
            ...
            //EDIT 6: all the DreamGeek comparisons were removed. Now, all AllGeeks has to worry about is
            //if the DreamGeek matches method returns true
...
//            if(!genericFeatures.getReligion().equals(dreamGeek.getReligion())) continue;
