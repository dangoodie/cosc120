...
public class Geek {
    ...
    public String getContactDetailsDescription(){
        return this.getName() + "'s phone number is: " + this.getPhoneNumber()+
                ".\nTheir email address is: "+this.getEmailAddress();
    }

    /**
     * @return a String describing a matching geek to the user
     * @param features the features to display in the description
     */
    public String getGeekDescription(Set<Criteria> features){
        return this.getName()+" is "+this.getAge()+" years old. "+this.genericFeatures.getDescription(features)+
