...
public enum ValentinesGifts {
    SELECT,CHESS_SET, BINARY_WRIST_WATCH, BREAKING_BAD_BOX_SET, CIRCUIT_BOARD_COASTERS,
    ...
    /**
     * @return a prettified description of the range of valentine's gifts
     */
    public String toString() {
        return switch (this) {
            case SELECT -> "Select preferred Valentine's Day gift";
